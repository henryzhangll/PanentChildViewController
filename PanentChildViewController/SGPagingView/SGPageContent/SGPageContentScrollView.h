 ...
 *
 *  @param pageContentScrollView     SGPageContentScrollView
 *  @param index                                         当前视图所在下标
 *  @param isViewLoaded                          当前视图是否加载过
 */
- (void)pageContentScrollView:(SGPageContentScrollView *)pageContentScrollView currentIndex:(NSInteger)index isViewLoaded:(BOOL)isViewLoaded;
